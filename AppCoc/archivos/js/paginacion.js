function mostrarPagina(pagina, filasPorPagina) {
    var tablaCompleta = document.getElementById("tablaScript");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  filtroInput.addEventListener("input", function () {
    ...
    var filas = document.querySelectorAll("#tablaScript tr");
    ...
    mostrarPagina(1, 11); // Actualiza la paginación al realizar una búsqueda
  });
