...
<body>
        ...
        <div class="p-4 rounded-3" style="background: #F5F4F4">
          <div>
            <div class="input-container mb-4 d-flex justify-content-between">
              <input type="search" placeholder="Buscar sanción" id="filtro" />
              <a href="funciones/crearsancion.php" class="btn btn-primary btn-sm"
                style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
                <i class="material-icons-outlined" style="font-size: 24px;">add</i>
              </a>
            </div>

            <?php
            // Fichero para mostrar las sanciones del Administrador
            
            require_once('funciones/mostrarsanciones.php');
            ?>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
    <path fill="#0099ff" fill-opacity="0.2"
      d="M0,96L40,80C80,64,160,32,240,58.7C320,85,400,171,480,197.3C560,224,640,192,720,186.7C800,181,880,203,960,218.7C1040,235,1120,245,1200,224C1280,203,1360,149,1400,122.7L1440,96L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z">
    </path>
  </svg>
